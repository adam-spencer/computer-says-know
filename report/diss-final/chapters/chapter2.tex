...
An \emph{output embedding} may be thought of as a way to link together an expected output (e.g. a word) and a vector for use in one-hot encoding space.
In the Transformer's decoder this allows a score represented in one-hot encoding space to be immediately matched to an output.
