...
In his 1960 work\cite{dynkin1960}, Dynkin describes a Markov process by using the example of a particle in space;

\say{
        Suppose a particle is in random motion in a space $E$ during the interval of time $[0,\zeta]$.
        ...
        The instant $\zeta$ at which the motion is cut off may be random.
}
